...
<body>
           ...
           <div class="headline-description">
               <div class="seperator">
                   ...
                   <div class="single-animation">
                       <h5>Food from all around the world</h5>
                       <a href="../NoonaInCucina2/login/login.php" class="btn cta-btn">Join us</a>
                   </div>
               </div>
           </div>
       </div>
           ...
           <div class="blog-info">
               <div class="blog-description padding-right animate-left">
                   ...
                   <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dignissimos laudantium quaerat expedita, a exercitationem quo ea vel excepturi nemo totam, praesentium rem ratione, velit ipsa. 
                    ...
                    <a href="aboutus.php" class="btn body-btn">About Us</a>
               </div>
               <div class="blog-info-img animte-right">
                   <img src="images/our-story-2.jpg" alt="">
               </div>
           </div>
       </div>
   </section>
   ...
   <section class="discover-various-recipes">
       <div class="container">
           <div class="blog-info">
               ...
               <div class="blog-description animate-right">
                <div class="global-headline">
                    ...
                    <h1 class="headline headline-dark">Various Recipes</h1>
                    <div class="asterisk"><i class="fas fa-asterisk"></i></div>
                   </div>
